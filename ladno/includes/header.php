...
<header class="bg-white shadow-sm py-3">
    <div class="container d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <img src="/assets/images/logo.png" alt="Логотип КУМЗ" height="68" class="me-3">
            <div>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="/postavshchikam.php">Поставщикам</a></li>
                <li class="nav-item"><a class="nav-link" href="/zakazchikam.php">Заказчикам</a></li>
            </ul>
