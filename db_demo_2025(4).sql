...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 27 2026 г., 05:26
...
INSERT INTO `feedback` (`id_feedback`, `surname`, `name`, `message`, `phone`, `email`, `created_at`) VALUES
(1, 'sgdsdggsdg', 'sdgsdgsdgsdg', 'sdgsdgsdgsdg', '124124124124', 'sdfsdfsd@mail.ru', '2026-04-25 21:07:27'),
(2, 'афафаф', 'афафафафаа', 'афавфааафа', '3434343434', 'gwggwegweg@mail.ru', '2026-04-25 21:16:45');
...
(2, 'Договор', '2024-10-30', 'Для производства судов на подводных крыльях. 30 октября на полях международного промышленного форума «Металл-Экспо 2024» состоялось подписание Договора о долгосрочном партнёрстве.', 'news_69ee3f5b5b54d.png', '2026-04-22 20:58:38');
...
(9, 'авпцпцуп', 'цупцупцуп', 'цупцупцуп', 'ladno', '3434342343434', 'sggsdgsdgsdg@mail.ru', '$2y$10$7OCARpjb8rkvWzkZfHuwSevi5Eu1S58.NW1b7NwQa0286Y3oJDMBK', 1);
